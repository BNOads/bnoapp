...
export const OrcamentosView = () => {
  ...
  return (
    <div className="space-y-6">
      {/* HEADER PERSONALIZADO (Substitui o header padrao do FerramentasView) */}
      <div className="bg-card rounded-2xl border border-border/50 shadow-sm p-6 mb-8 relative overflow-hidden">
        ...
        <div className="flex items-start justify-between flex-col xl:flex-row gap-6 relative z-10 xl:items-center">
          <div className="flex items-start gap-4">
            <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400">
              <Filter className="h-8 w-8" />
            </div>
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-foreground/90">Gestão de Funis</h1>
          ...
          {/* FAIXA DE BENCHMARKS */}
          <div className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl p-3 shadow-lg flex-shrink-0 w-full xl:w-auto">
            <div className="flex items-center gap-2 mb-2">
              <Zap className="h-4 w-4 text-white" />
              <span className="text-white font-bold text-sm tracking-wide">BENCHMARKS DE MERCADO</span>
            </div>
            <div className="flex flex-wrap md:flex-nowrap gap-2">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 text-center flex-1 min-w-[70px]">
                <p className="text-white/80 text-[10px] font-medium uppercase tracking-wide">CPM</p>
                <p className="text-white text-lg font-bold">R$15</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 text-center flex-1 min-w-[70px]">
                <p className="text-white/80 text-[10px] font-medium uppercase tracking-wide">CTR</p>
                <p className="text-white text-lg font-bold">1.5%</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 text-center flex-1 min-w-[70px]">
                <p className="text-white/80 text-[10px] font-medium uppercase tracking-wide">Carregamento</p>
                <p className="text-white text-lg font-bold">85%</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 text-center flex-1 min-w-[70px]">
                <p className="text-white/80 text-[10px] font-medium uppercase tracking-wide">Checkout</p>
                <p className="text-white text-lg font-bold">30%</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 text-center flex-1 min-w-[70px]">
                <p className="text-white/80 text-[10px] font-medium uppercase tracking-wide">Conversao</p>
                <p className="text-white text-lg font-bold">3%</p>
              </div>
            </div>
            <p className="text-white/70 text-[10px] mt-2 text-center md:text-right">
              Valores ideais de referencia para trafego pago
            </p>
          </div>
        </div>
      </div>

      <Tabs defaultValue="orcamentos" className="space-y-2">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-2">
          {canManageBudgets && (
            <Button onClick={() => setModalNovo(true)} className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white">
        ...
        <TabsContent value="orcamentos" className="space-y-4 mt-0">
