...
CREATE TABLE public.reunioes_templates (
  ...
  created_by UUID, -- Allow null for system templates
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);
...
-- Insert default templates (system templates with null created_by)
INSERT INTO public.reunioes_templates (nome, descricao, blocos_template, created_by) VALUES
